    ...
    <div>
      ...
      <div className="onboarding">
        ...
        <form onSubmit={formik.handleSubmit}>
          <section>
            <label>Profile Photo (Add URL/Link)</label>
            <input
              id="url"
              type="url"
              name="url1"
            ...
            <label>Add more photos to your profile (Optional)</label>
            <input
              id="url2"
              type="url"
              name="url2"
              ...
              onChange={formik.handleChange}
            />
            {formik.touched.url2 && formik.errors.url2 && <div className="errors">{formik.errors.url2}</div>}
            {formik.values.url2 && <img className="profile-photo" src={formik.values.url2} alt="" />}   
            <input
              id="url3"
              type="url"
              name="url3"
              ...
              onChange={formik.handleChange}
            />
            {formik.touched.url3 && formik.errors.url3 && <div className="errors">{formik.errors.url3}</div>}
            {formik.values.url3 && <img className="profile-photo" src={formik.values.url3} alt="" />}   
            <input
              id="url4"
              type="url"
              name="url4"
              ...
              onChange={formik.handleChange}
            />
            {formik.touched.url4 && formik.errors.url4 && <div className="errors">{formik.errors.url4}</div>}
            {formik.values.url4 && <img className="profile-photo" src={formik.values.url4} alt="" />}   
            <input
              id="url5"
              type="url"
              name="url5"
              ...
              onChange={formik.handleChange}
            />
            {formik.touched.url5 && formik.errors.url5 && <div className="errors">{formik.errors.url5}</div>}
            {formik.values.url5 && <img className="profile-photo" src={formik.values.url5} alt="" />}   
          </section>
          ...
          <section>
            ...
            <div className="multiple-input-container">
              <input 
                ...
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
                checked={formik.values.gender_identity === 'male'}
              />
              ...
              <input 
                ...
                onBlur={formik.handleBlur}
                onChange={formik.handleChange}
                checked={formik.values.gender_identity === 'female'}
              />
            ...
            <div className="multiple-input-container">
              <input 
                  ...
                  onBlur={formik.handleBlur}
                  onChange={formik.handleChange}
                  checked={formik.values.gender_interest === 'male'}
              />
              ...
              <input 
                  ...
                  onBlur={formik.handleBlur}
                  onChange={formik.handleChange}
                  checked={formik.values.gender_interest === 'female'}
              />
